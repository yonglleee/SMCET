...
LastEditTime: 2021-12-19 14:01:09
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        self.lr_blocks = nn.ModuleList([LRBlock(ms_channels, base_filter) for i in range(n_layer)])
        self.pan_blocks = nn.ModuleList([PANBlock(ms_channels, 1, base_filter, 1) for i in range(n_layer)])
