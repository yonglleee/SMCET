...
class KitModel(nn.Module):
    ...
    def __init__(self, weight_file):
        ...
        self.conv8_1 = self.__conv_transpose(2, name='conv8_1', in_channels=512, out_channels=256, kernel_size=(3, 3), stride=(2, 2), groups=1, bias=True, padding=1, output_padding=1)
        self.conv8_2 = self.__conv(2, name='conv8_2', in_channels=256, out_channels=128, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=True, dilation=1, padding=1)
        self.conv8_3 = self.__conv(2, name='conv8_3', in_channels=128, out_channels=64, kernel_size=(3, 3), stride=(1, 1), groups=1, bias=True, dilation=1, padding=1)
