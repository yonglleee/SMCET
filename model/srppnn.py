...
LastEditTime: 2021-12-19 13:35:09
...
class Net(nn.Module):
    def __init__(self, args):
        ...
        res_block_s1.append(ConvBlock(32, num_channels, 3, 1, 1, activation='prelu', norm=None, bias = False))
        ...
        res_block_s2.append(ConvBlock(32, num_channels, 3, 1, 1, activation='prelu', norm=None, bias = False))
        ...
        res_block_s3.append(ConvBlock(32, num_channels, 3, 1, 1, activation='prelu', norm=None, bias = False))
        ...
        res_block_s4.append(ConvBlock(32, num_channels, 3, 1, 1, activation='prelu', norm=None, bias = False))
